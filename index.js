...
console.log("Kenar uzunlugu 10 cm olan karenin alani: ", KareninAlani(10));
...
console.log("5 cm yaricapli cemberin cevresi: ", CemberinCevresi(5));
...
console.log("Yaricapi 15 cm olan cemberin alani: ", CemberinAlani(15, pi));
...
console.log("Sayilar dizisinde kac eleman var? ", sayilar.length);
...
console.log("Uce bolunen sayilarin toplami: ", ucebolunenlerintoplami);

//3d çözümü

besyuzdenkucuksayilar = sayilar.filter((sayi) => sayi < 500);

console.log("Dizideki 500'den kucuk sayilar", besyuzdenkucuksayilar);
